...
.company-intro h1 { font-size: clamp(2.5rem, 5vw, 4rem); font-weight: 800; margin-bottom: 20px; color: white; }
.highlight {
  color: var(--primary); /* Solid color, no gradient */
}
...
.value-card h3 { margin-bottom: 10px; font-size: 1.2rem; color: white; }
